...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    await prisma.message.create({
      data: {
        content: 'How long have you been experiencing them? Are they accompanied by any other symptoms?',
        senderId: doctor1.id,
    ...
    await prisma.message.create({
      data: {
        content: 'I would like to schedule an appointment to check this further. Can you come in tomorrow?',
        senderId: doctor1.id,
        receiverId: patient1.id,
        conversationId: conversation1.id,
        read: false,
