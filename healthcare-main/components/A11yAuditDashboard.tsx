...
export const A11yAuditDashboard: React.FC<A11yAuditDashboardProps> = ({ scanResult, onRescan }) => {
        ...
        {filteredIssues.map((issue, index) => (
          <div
            ...
            className={`p-3 rounded-md ${
              issue.severity === A11ySeverity.CRITICAL
                ? "bg-red-100"
                : issue.severity === A11ySeverity.HIGH
                  ? "bg-orange-100"
                  : issue.severity === A11ySeverity.MEDIUM
                    ? "bg-yellow-100"
                    : "bg-green-100"
            }`}
          >
        ...
        <div>
          ...
          <div className="bg-gray-100 p-4 rounded-md">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-bold text-red-600">{localScanResult.criticalIssues}</span>
            </div>
          </div>
        </div>
