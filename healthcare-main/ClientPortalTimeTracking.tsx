    ...
    const fetchTimeData = async () => {
      ...
      try {
        ...
        const entriesResponse = await axios.get(
          `/api/client-portal/time-entries?${params.toString()}`,
        );
              ...
              <TableBody>
                {projectSummaries.map((summary) => {
                  const billablePercentage =
                    summary.totalHours > 0 ? (summary.billableHours / summary.totalHours) * 100 : 0;
          ...
          return (
            <div key={dateKey}>
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="text-sm text-muted-foreground">Total: {formatTime(dailyTotal)}</div>
              </div>
