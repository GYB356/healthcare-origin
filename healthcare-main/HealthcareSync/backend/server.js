...
io.on("connection", (socket) => {
  ...
  socket.on("deviceData", (data) => {
    ...
    logHIPAAEvent({ headers: socket.handshake.headers }, "Device data received", {
  ...
  socket.on("scheduleUpdate", (data) => {
    ...
    logHIPAAEvent({ headers: socket.handshake.headers }, "Schedule updated", {
