...
const InsuranceModal = ({ isOpen, onClose, insurance, onSave, mode = "add" }) => {
  const { user } = useAuth();
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      const insuranceData = {
        ...
        documentUrl:
          mode === "edit" && insurance && !formData.documentFile ? insurance.documentUrl : null,
      };
      ...
      // Log HIPAA event
      logHIPAAEvent(
        `User ${user.id} ${mode === "add" ? "added" : "updated"} insurance information`,
      );
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-600">
                      ...
                      <a
                        ...
                        onClick={() =>
                          logHIPAAEvent(
                            `User ${user.id} viewed insurance document for insurance ID ${insurance.id}`,
                          )
                        }
                      >
                        View Document
