    ...
    return (
      <div data-testid="invoice-list">
        <button
          ...
          onClick={() => onViewInvoice({ id: "1", invoiceNumber: "INV-001" })}
        >
          View Invoice
        </button>
        <button
          data-testid="pay-invoice-btn"
          onClick={() => onPayInvoice({ id: "1", invoiceNumber: "INV-001" })}
        >
          Pay Invoice
        </button>
    ...
    return (
      <div data-testid="payment-methods">
        <button
          ...
          onClick={() => onAddPaymentMethod({ id: "1", type: "credit_card" })}
        >
          Add Payment Method
        </button>
        <button
          data-testid="edit-payment-btn"
          onClick={() => onEditPaymentMethod({ id: "1", type: "credit_card" })}
        >
          Edit Payment Method
        </button>
        ...
        <button
          ...
          onClick={() => onSelectPaymentMethod({ id: "1", type: "credit_card" })}
        >
    ...
    return (
      <div data-testid="insurance-modal">
        <button
          ...
          onClick={() => onSave({ id: "1", provider: "Test Insurance" })}
        >
          Save Insurance
        </button>
...
describe("Billing Component", () => {
  ...
  test("handles creating a new invoice", async () => {
    ...
    fireEvent.change(screen.getByLabelText("Description*"), {
      target: { value: "Specialist consultation" },
    });
