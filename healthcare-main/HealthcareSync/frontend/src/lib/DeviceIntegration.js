...
const DeviceIntegration = () => {
  ...
  const displayDeviceStatus =
    Object.keys(deviceStatus).length > 0 ? deviceStatus : mockDeviceStatus;
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        {departments.find((d) => d.id === device.department)?.name ||
                          device.department}
                      </p>
                    </div>
                        ...
                        className={`inline-block w-3 h-3 rounded-full mr-2 ${
                          displayDeviceStatus[device.id] === "online"
                            ...
                            : displayDeviceStatus[device.id] === "offline"
                              ? "bg-gray-500"
                              : displayDeviceStatus[device.id] === "maintenance"
                                ? "bg-yellow-500"
                                : displayDeviceStatus[device.id] === "error"
                                  ? "bg-red-500"
                  ...
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      displayDeviceStatus[selectedDevice.id] === "online"
                        ...
                        : displayDeviceStatus[selectedDevice.id] === "offline"
                          ? "bg-gray-100 text-gray-800"
                          : displayDeviceStatus[selectedDevice.id] === "maintenance"
                            ? "bg-yellow-100 text-yellow-800"
                            : displayDeviceStatus[selectedDevice.id] === "error"
                    ...
                    <div className="mt-2 space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm font-medium">
                          {deviceTypes.find((t) => t.id === selectedDevice.type)?.name ||
                            selectedDevice.type}
                        </span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm font-medium">
                          {departments.find((d) => d.id === selectedDevice.department)?.name ||
                ...
                {displayDeviceStatus[selectedDevice.id] !== "online" && (
                  <div className="bg-gray-50 p-8 rounded text-center">
                    <p className="text-gray-600">
                      Device is currently {displayDeviceStatus[selectedDevice.id]}. Connect the
                      device to view data.
                    </p>
                  </div>
                )}
