        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
              A comprehensive healthcare platform designed to streamline healthcare operations,
              improve patient care, and ensure HIPAA compliance.
            </p>
            <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
              <FiHeart className="mr-2 text-primary-500" />
              Made with care for healthcare professionals and patients
            </div>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:support@healthcaresync.com"
                  className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400"
                >
                  support@healthcaresync.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a
                href="https://twitter.com/healthcaresync"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/healthcaresync"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400"
              >
              ...
              <a
                href="https://www.facebook.com/healthcaresync"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400"
              >
              ...
              <a
                href="https://www.instagram.com/healthcaresync"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400"
              >
