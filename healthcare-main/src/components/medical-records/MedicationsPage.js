    ...
    >
      ...
      <div className="mb-8">
        ...
        {medications.filter((med) => med.status === "completed").length === 0 && (
          <div className="text-center py-8 border border-dashed border-gray-300 dark:border-gray-700 rounded-lg">
            <p className="text-gray-600 dark:text-gray-400">No medication history available.</p>
          </div>
        )}
      </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-yellow-700 dark:text-yellow-400 text-sm mt-1">
              Always take medications as prescribed by your doctor. Do not adjust dosages or stop
              taking medications without consulting your healthcare provider.
            </p>
          </div>
        </div>
      </div>
