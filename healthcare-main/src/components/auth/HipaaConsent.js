        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-md overflow-y-auto max-h-96">
          ...
          <div className="prose dark:prose-invert max-w-none text-sm">
            ...
            <p>
              ...
              test results, diagnoses, treatment, and a plan for future care or treatment. This
            ...
            <ul>
              ...
              <li>
                Source of information for public health officials charged with improving the health
                of the nation
              </li>
            ...
            <p>HealthcareSync is required to:</p>
            <ul>
            ...
            <p>
              ...
              change, we will post the revised notice in our facility and on our website.
            </p>
            ...
            <p>
              ...
              HealthcareSync Privacy Officer at 1-800-555-1234.
            </p>

            <p>
              If you believe your privacy rights have been violated, you can file a complaint with
              the HealthcareSync Privacy Officer or with the Secretary of Health and Human Services.
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label htmlFor="consent" className="font-medium text-gray-700 dark:text-gray-300">
                I have read and understand the HIPAA Privacy Notice and consent to the use and
                disclosure of my health information as described.
              </label>
            </div>
          </div>
