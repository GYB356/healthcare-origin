...
const InvoicePayment = () => {
  ...
  useEffect(() => {
    const fetchInvoiceAndPaymentMethods = async () => {
      try {
        ...
        setError(
          err.response?.data?.message || "Failed to load invoice data. Please try again later.",
        );
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Failed to process payment. Please try again later.");
      setProcessingPayment(false);
    }
  };
      ...
      <div className="rounded-md bg-red-50 p-4">
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-4">
              <Link to="/billing" className="text-sm font-medium text-red-800 hover:text-red-700">
