              ...
              <div>
                ...
                <div className="mt-1 border-t border-gray-200 pt-2">
                  <div className="flex items-start py-2">
                    ...
                    <p className="text-sm text-gray-600">
                      {currentImage.radiologistNotes || "No notes available."}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1 border-t border-gray-200 pt-2">
                  <p className="text-sm text-gray-600 py-2">
                    {currentImage.findings || "No findings recorded."}
                  </p>
                </div>
              </div>
              ...
              {shareSuccess && (
                <div className="mb-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-md">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-green-700">Image shared successfully!</p>
                    </div>
                  </div>
                </div>
              )}
