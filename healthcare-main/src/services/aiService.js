    ...
    this.mockResponses = {
      healthInsights: [
        {
          ...
          description:
            "Your blood pressure readings show consistent improvement over the past 3 months.",
          confidence: 0.92,
          severity: "positive",
        },
        {
          ...
          description:
            "Based on your hydration metrics, consider increasing daily water consumption by 20%.",
          confidence: 0.85,
          severity: "moderate",
        },
        {
          ...
          description:
            "Your sleep tracker indicates irregular sleep patterns that may affect recovery.",
          confidence: 0.78,
          severity: "warning",
        },
      ],
      riskAssessment: [
        ...
        },
        {
          ...
          probability: 0.58,
          factors: ["Sleep patterns", "BMI", "Snoring reported"],
          trend: "increasing",
        },
      ],
      medicationInsights: [
        {
          ...
          insight: "Effectiveness appears optimal based on blood pressure response",
          alternatives: ["Losartan", "Enalapril"],
        },
        {
          id: "med2",
          medication: "Metformin",
          insight: "Current dosage may need adjustment based on recent A1C levels",
          alternatives: [],
        },
      ],
    };
  ...
  async analyzeSymptoms(patientId, symptoms) {
    try {
      ...
      const response = await axios.post(
        `${this.apiUrl}/ai/symptom-analysis`,
        {
          patientId,
          symptoms,
        },
