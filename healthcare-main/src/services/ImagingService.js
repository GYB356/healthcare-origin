  ...
  constructor() {
    ...
    this.mockImages = [
      ...
      },
      {
        ...
        radiologistNotes:
          "No evidence of acute intracranial hemorrhage, mass effect, or midline shift. Ventricles are normal in size and configuration.",
      ...
      },
      {
        ...
        radiologistNotes:
          "Liver, spleen, pancreas, and adrenal glands appear normal. No free fluid or free air. No lymphadenopathy.",
      ...
      },
      {
        ...
        orderedBy: "Dr. Sarah Johnson",
        radiologistNotes:
          "Thyroid is normal in size and echotexture. No nodules or masses identified.",
      ...
      if (this.mockMode) {
        ...
        if (options.dateRange) {
          ...
          filteredImages = filteredImages.filter((img) => {
            ...
            return (!start || imgDate >= new Date(start)) && (!end || imgDate <= new Date(end));
          });
        }
        ...
        return [
          {
            id: "xray",
            name: "X-Ray",
            description: "Uses radiation to produce images of internal structures",
          },
          {
            id: "mri",
            name: "MRI",
          ...
          { id: "mammogram", name: "Mammogram", description: "X-ray imaging of breast tissue" },
          {
            id: "dexa",
            name: "DEXA Scan",
            description: "Measures bone density using low-dose X-rays",
          },
          {
            id: "pet",
            name: "PET Scan",
            description: "Uses radioactive tracers to show metabolic activity",
          },
        ];
      }
    ...
    try {
      ...
      if (this.mockMode) {
        ...
        return {
          ...
          expiresAt:
            shareData.expiration || new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
