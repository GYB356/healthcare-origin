...
const A11yAuditDashboard: React.FC<AuditDashboardProps> = ({
  ...
  const handleToggleAutoAudit = () => {
    if (autoAuditEnabled) {
      ...
      announce(
        `Automatic accessibility audits enabled, running every ${auditInterval} minutes`,
        false,
      );
    }
  };
        ...
        <div className="a11y-audit-controls">
          ...
          <div className="a11y-audit-control-group">
            ...
            <div className="a11y-audit-toggle">
              <label htmlFor="auto-audit-toggle" className="a11y-audit-toggle-label">
                Automatic Audits
              </label>
              <input
            ...
            <div className="a11y-audit-input-group">
              <label htmlFor="audit-interval-input" className="a11y-audit-input-label">
                Interval (minutes)
              </label>
              <input
            ...
            <div className="a11y-audit-input-group">
              <label htmlFor="webhook-url-input" className="a11y-audit-input-label">
                Webhook URL
              </label>
                  ...
                  <div className="a11y-audit-violations">
                    ...
                    <ul className="a11y-audit-violations-list">
                      {selectedAudit.results.violations.map((violation) => (
                        <li
                          key={violation.id}
                          className={`a11y-audit-violation a11y-audit-violation-${violation.impact}`}
                        >
              ...
              <li key={rule.id} className="a11y-audit-rule">
                <div className="a11y-audit-rule-header">
                  <div className="a11y-audit-rule-title">
                    ...
                    <span
                      className={`a11y-audit-rule-severity a11y-audit-rule-severity-${rule.severity}`}
                    >
                      {rule.severity}
                    </span>
                  </div>
