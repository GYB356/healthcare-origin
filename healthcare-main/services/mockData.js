export const generateMockData = (user) => {
  ...
  const roleData = {
    admin: {
      ...
      systemAlerts: [{ id: "alert-1", type: "critical", message: "Server disk space low" }],
    },
    provider: {
      patients: 28,
      appointments: [{ id: "appt-1", patient: "John Smith", time: "2:30 PM", date: "2025-03-15" }],
    },
    patient: {
      appointments: [
        { id: "appt-2", doctor: "Dr. Sarah Johnson", type: "Checkup", date: "2025-03-18" },
      ],
      prescriptions: [{ id: "rx-1", medication: "Amoxicillin", dosage: "500mg", refills: 2 }],
      healthMetrics: {
